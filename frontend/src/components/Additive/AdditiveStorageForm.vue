  ...
  <div class="container mt-4">
    ...
    <form @submit.prevent="submitForm" enctype="multipart/form-data">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="supplier" v-model="form.supplier" required>
              ...
              <option>DSM</option>
              <option>ARTETA Y MURTHINO-ALIMEC</option>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="driverName" @input="convertToUppercase('driver_name')" v-model="form.driver_name">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="foodTransportValidity" @input="convertToUppercase('food_transport_validity')" v-model="form.food_transport_validity">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="invoiceNumber" @input="convertToUppercase('invoice_number')" v-model="form.invoice_number">
        </div>
    ...
    <div class="mb-3">
      ...
      <div v-if="form.truck_condition_image_confirmation === 'SI'" class="mt-2">
        ...
        <input type="file" class="form-control" id="truckConditionImage" ref="truckConditionImage" @change="handleFileUpload('truck_condition_image', $event)">
      </div>
    </div>
    ...
    <div class="mb-3">
      ...
      <div v-if="form.truck_plate_image_confirmation === 'SI'" class="mt-2">
        ...
        <input type="file" class="form-control" id="truckPlateImage" ref="truckPlateImage" @change="handleFileUpload('truck_plate_image', $event)">
      </div>
    </div>
      ...
      <div class="card mb-4">
        ...
        <div class="mb-3">
          ...
          <input type="number" placeholder="1.0" step="0.01" min="0" max="1000" class="form-control" id="totalWeight" v-model="form.total_weight" required>
        </div>
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="rejectionReasons" @input="convertToUppercase('rejection_reasons')" v-model="form.rejection_reasons"></textarea>
        </div>
  
        <!-- Recibido por -->
        <div class="mb-3">
          <label for="receivedBy" class="form-label">Recibido por</label>
          <input type="text" class="form-control" id="receivedBy" @input="convertToUppercase('received_by')" v-model="form.received_by" required>
        </div>
...
<style scoped>
  ...
  .custom-back-button {
    ...
    justify-content: center; /* Centra contenido horizontalmente dentro del botón */
    background-color: #ffffff; /* Cambia al color deseado */
    ...
    transition: background-color 0.3s; /* Animación al cambiar color */
}

/* Cambia el color al pasar el mouse */
.custom-back-button:hover {
    background-color: #e3e6e9; /* Cambia ligeramente el color */
}

/* Estilo para el ícono */
.button-icon {
    width: 22px; /* Tamaño del ícono */
    height: 22px; /* Tamaño del ícono */
}
...
.custom-header {
    ...
    flex-wrap: wrap; /* Permite que el contenido haga wrap si no cabe */
    padding: 10px; /* Añade espacio dentro del header */
