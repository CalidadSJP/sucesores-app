      ...
      <div class="card-body">
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="releaseCriteria" id="criteriaYes" value="SI"
                  v-model="releaseCriteria" required />
                <label class="form-check-label" for="criteriaYes">Sí</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="releaseCriteria" id="criteriaNo" value="NO"
